...
<div class="container min-w-full w-full bg-solarizedBase3 text-solarizedBase02">
	<div class="grid grid-cols-1 md:grid-cols-3">
		...
		<div class="mt-10">
			...
			<blockquote>
				<p class="animate-fade-in-down mx-12 mb-9 text-center text-sm">Eh</p>
			</blockquote>
		</div>
        <div class="mt-10">
			<div class="flex justify-center">
			...
			<div class="animate-fade-in-down mb-1 text-center text-lg text-sky-600">Mustafa Siam Ur Rafique</div>
			<div class="animate-fade-in-down mb-8 text-center text-lg text-sky-800">
				Your regular Cat
			</div>
			<blockquote>
